        ...
        <div className="px-4 pb-4">
          <div className="mb-4 max-h-60 overflow-y-auto">
            {comments.map((comment) => (
              <div
                key={comment._id}
                className="mb-2 bg-transparent p-2 rounded flex items-start"
              >
                <img
          ...
          <form onSubmit={handleAddComment} className="flex items-center">
            <input
              ...
              className="flex-grow py-2 pl-4 rounded-full border border-gray-400 bg-transparent focus:outline-none focus:border-gray-300"
            />
