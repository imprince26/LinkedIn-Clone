      ...
      {isEditing && (
        <div className="mt-4">
          ...
          <input
            ...
            className="w-full p-2  bg-transparent border border-gray-400 rounded mb-3"
          />
          <button
            onClick={handleAddEducation}
            className="bg-primary text-white py-1 px-2 rounded hover:bg-primary-dark transition duration-300"
          >
            Add Education
          </button>
        </div>
      ...
      {isOwnProfile && (
        <>
          {isEditing ? (
            <button
              onClick={handleSave}
              className="mt-4 bg-primary text-white py-1 px-2 rounded hover:bg-primary-dark
